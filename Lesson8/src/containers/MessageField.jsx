...
const MessageField = (props) => {
    ...
    const updateScroll = () => {
        let messageList = document.getElementsByClassName('msgField')[0];
        messageList.scrollTop = messageList.scrollHeight;
    };

    let messageElements = props.chats[props.chatId].messageList.map((messageId, i) => <Message key={i} text={props.messages[messageId].text} sender={props.messages[messageId].sender} removeMessage={() => handleRemoveMessage(messageId)} />);
